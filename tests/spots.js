...
describe('spots', () => {
    ...
    it('adds and displays two spots', async () => {
    ...
    it('deletes exisiting spot', async () => {
    ...
    it("can't delete non-exisiting spot", async () => {
        await sut.addSpot('delspot')
        await sut.addSpot('delspot')
    ...
    it("can't change non-existing spot", async () => {
